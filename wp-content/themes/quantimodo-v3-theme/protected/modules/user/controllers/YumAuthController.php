	...
	public function authenticate($user) {
		...
		switch($identity->errorCode) {
			...
			case YumUserIdentity::ERROR_STATUS_REMOVED:
				$this->loginForm->addError('status', Yum::t('Your account has been deleted.').' Please write to the <a href="mailto:'.Yii::app()->params['adminEmail'].'?Subject=Please%20revive%20my%20Quantimodo%20account!">site admin</a> in order to revive your account.');
				break;
			case YumUserIdentity::ERROR_PASSWORD_INVALID:
				Yum::log( Yum::t(
