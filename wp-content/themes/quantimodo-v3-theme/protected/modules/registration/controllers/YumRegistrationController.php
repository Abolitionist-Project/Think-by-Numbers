	...
	public function actionRegistration() {
		...
		if (isset($_POST['YumRegistrationForm'])) { 
			...
			if(!$form->hasErrors() && !$profile->hasErrors()) {
				...
				Yum::setFlash('Thank you for your registration. Please check your email.',30000);
				...
				if ($form->validate()) {
					if($form->user instanceof YumUser) {
						if($form->user->status <= 0)	
							throw new CHttpException(403, 'User is not active! Please check your email for activation instructions!',403);
