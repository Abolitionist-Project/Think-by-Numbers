...
<div class="form">
You can register with any of the providers: 
<?php $this->widget('application.modules.hybridauth.widgets.renderProviders'); ?>
<div style='clear:both'></div>
<br><p>Or you can fill the form with your own login credentials:</p>
...
echo $activeform->textField($profile,'email',array('placeholder'=>'Your email goes here','value'=>''));
?> </div>  
...
<? if(extension_loaded('gd') 
	...
	<div class="row submit">
		<? echo CHtml::submitButton(Yum::t('Register!')); ?>
	</div>
