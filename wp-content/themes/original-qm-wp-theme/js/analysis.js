...
function adjustPointer(val) {
	...
	if(val > maxVal)
	   { var pointerValue = maxVal;}
	else if(val < minVal)
	   { var pointerValue = minVal;}
	else
	   { var pointerValue = val;}
        ctx1.save();
    ...
    pointerImage.src = 'images/pointer-image.png';
}
