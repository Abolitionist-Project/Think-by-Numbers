...
function array_to_table($arr,$head_row='',$caption='',$rows_num=100){ 
	...
	// print_r($ths); 
	print "<thead><tr><th class='table-filterable table-sortable:numeric table-sortable'>No.</th>";
...
if (!empty($_POST['all_correlations'])) {
	...
	array_to_table($all_correlations,"Input,Count,Start,End,PCC,PCC_word,PCC_%","All_corellations in one place",1000);
