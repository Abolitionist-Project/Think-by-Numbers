	...
	array(
		array(
			...
			'default_value'	=> 'on'
                ...
                array(
			'id_name'	=> 'amazon_rating',
			'label'		=> __('Amazon Rating', 'euged'),
			'type'		=> 'text'
		),
                array(
			'id_name'	=> 'number_of_amazon_ratings',
			'label'		=> __('Number of Amazon Ratings', 'euged'),
			'type'		=> 'text'
		),
                array(
			'id_name'	=> 'price',
			'label'		=> __('Price', 'euged'),
			'type'		=> 'text'
		),
                array(
			'id_name'	=> 'amazon_link',
			'label'		=> __('Amazon Link', 'euged'),
			'type'		=> 'text'
		),
                array(
			'id_name'	=> 'amazon_customer_reviews_link',
			'label'		=> __('Amazon Customer Reviews Link', 'euged'),
			'type'		=> 'text'
		),
                array(
			'id_name'	=> 'itunes_link',
			'label'		=> __('iTunes Link', 'euged'),
			'type'		=> 'text'
		),
                array(
			'id_name'	=> 'play_store_link',
			'label'		=> __('Play Store Link', 'euged'),
			'type'		=> 'text'
		),
                array(
			'id_name'	=> 'chrome_web_store_link',
			'label'		=> __('Chrome Web Store Link', 'euged'),
			'type'		=> 'text'
		),
                array(
			'id_name'	=> 'affiliate_link',
			'label'		=> __('Affiliate Link', 'euged'),
			'type'		=> 'text'
		),
		array(
