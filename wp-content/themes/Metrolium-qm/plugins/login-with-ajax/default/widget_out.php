...
*/
?>
	<img src="https://i.imgur.com/1nnjeto.png" style="padding-bottom: 10px;">
	<div class="lwa lwa-default"><?php //class must be here, and if this is a template, class name should be that of template directory ?>
        <form class="lwa-form" action="<?php echo esc_attr(LoginWithAjax::$url_login); ?>" method="post">
            ...
            <table>
                ...
                <tr><td colspan="2" style="text-align: right"><?php do_action('login_form'); ?></td></tr>
                <tr class="lwa-submit">
                    <td class="lwa-submit-links" colspan="2">
                        <input name="rememberme" type="checkbox" class="lwa-rememberme" value="forever" /> <label style="display:inline;"><?php esc_html_e( 'Remember Me','login-with-ajax' ) ?></label>
                ...
                <tr class="lwa-submit">                    
		    <td class="lwa-submit-button" style="text-align:center;" colspan="2">
                        <input type="submit" name="wp-submit" id="lwa_wp-submit" value="<?php esc_attr_e('Log In', 'login-with-ajax'); ?>" tabindex="100" style="width:100%;" />
