...
function bp_course_activity_filter( $has_activities,$activities) {
    global $bp;
    ...
    foreach ( $activities->activities as $key => $activity ) {
    	...
    	if( !current_user_can('edit_posts') && ($activity->user_id != $bp_loggedin_user_id) && (in_array($activity->component,array('course','quiz','unit'))))
...
//add_action( 'bp_has_activities', 'bp_course_activity_filter', 10, 9 );
